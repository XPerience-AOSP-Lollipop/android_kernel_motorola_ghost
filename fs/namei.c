...
static int inode_only_permission2(struct vfsmount *mnt, struct inode *inode,
				  int mask)
{
	int retval;
...
{
	return inode_only_permission2(NULL, inode, mask);
}
...
int inode_permission2(struct vfsmount *mnt, struct inode *inode, int mask)
{
	...
	return inode_only_permission2(mnt, inode, mask);
}
